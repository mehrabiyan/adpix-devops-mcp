...
const FIXTURES: Record<string, Record<string, unknown>> = {
  ...
  honeypot: { server: "prod", action: "plan" },
  egress_lockdown: { server: "prod", action: "report" },
  net_diag: { server: "prod" },
  kafka_deploy: { server: "prod" },
  kafka_health: { server: "prod" },
  kafka_topics: { server: "prod", action: "list" },
  kafka_lag: { server: "prod" },
  kafka_tune: { server: "prod" },
